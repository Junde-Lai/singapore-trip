...
if page == "📅 行程總覽":
    ...
    with day_tab3:
        ...
        render_spot_card(
            "20:30 - 21:45", "金沙 CÉ LA VI SkyBar - 高空微醺夜 🍸",
            "登上 57 層樓之巔！在 CÉ LA VI SkyBar 點杯調酒，您可以俯視著名的無邊際泳池，並將濱海灣的閃耀燈海盡收眼底。21:00 時，還可以從高空視角俯瞰下方的雷射水舞秀，享受頂級的視聽饗宴。",
            tips="有 Smart Casual 服裝要求。請提前線上訂位並選擇 Outdoor Bar。",
            details="**📍 位置：** 金沙酒店第 3 塔樓 (Tower 3) 頂樓電梯直達。"
            **🚇 交通指南：**
        ...
        render_spot_card(
            "22:00 - 23:00", "🌟 晝夜璀璨藝術節 (Light to Night 2026)",
    ...
    with day_tab5:
        ...
        render_spot_card(
            "08:00 - 10:00", "Slow Morning：飯店早餐與最後採買",
            "旅程的最後一個早晨不需要趕路。在飯店享用完早餐後，您可以和媽媽到飯店直通的 Tanglin Mall 逛逛。這裏有高品質的超市（如 Marketplace）可以買到精緻的新加坡香料、醬料或果醬。或是前往附近的南洋老牌咖啡店，體驗當地人最日常的早茶生活，享受離開前的悠閒節奏。",
            food=["Killiney Kopitiam 傳統咖啡", "飯店早餐"],
            tips="11:30 辦理退房，建議直接從飯店叫車 (Grab) 前往機場，節省體力負荷。",
            details="Tanglin Mall 內有許多質感小店，適合最後的伴手禮補充。"
        )
        render_spot_card(
            "10:00 - 11:30", "武吉士 (Bugis) 最後採買",
