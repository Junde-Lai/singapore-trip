...
# --- 3. 側邊欄：基本資訊 ---
with st.sidebar:
    st.image("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/e88c7f58-2159-4a3c-8ee4-3919ed7f8a19/dg02zac-b7472d06-5c0c-492a-bd57-69dbaf190b2a.png/v1/fill/w_120,h_120,q_80,strp/merlion_singapore_icon_by_bamen716_dg02zac-fullview.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..5O8gC0e5L4o4_X4o4_X4o4_X4o4_X4o4_X4o4_X4o4", width=120)
    st.title("🇸🇬 新加坡深度遊")
    st.markdown("---")
...
if page == "📅 行程總覽":
    ...
    with day_tab3:
        ...
        render_spot_card(
            ...
            tips="超級樹燈光秀時間通常為 19:45 和 20:45 (免費)，建議提早 15 分鐘找個好位置席地而坐或躺著觀賞，視野最佳。",
            details="""
            **🚇 交通指南：**
            搭乘地鐵至 **Bayfront (CE1/DT16)** 站，**B 出口**跟著指示牌走地下道即可抵達濱海灣花園入口。
            
            **🎫 門票建議：**
            兩大冷室 (Cloud Forest & Flower Dome) 門票建議事先上網買 (Klook/KKday)。
            超級樹燈光秀是**免費**的，地點在 Supertree Grove 戶外廣場。
            若要上空橋 (OCBC Skyway) 走在樹冠層之間，需另外購票，視野極佳但有懼高症者請斟酌。
            """
        )
