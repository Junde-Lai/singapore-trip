...
locations = pd.DataFrame({
    'name': ['JEN Tanglin', '樟宜機場', '中峇魯', '福康寧公園', '克拉碼頭', '小印度', '甘榜格南', '牛車水', '植物園', '濱海灣金沙', '濱海灣花園', '聖淘沙', '如切/加東', '讚美廣場', '舊禧街警察局', 'Manhattan Bar', 'Dempsey Hill', 'Light to Night', '萊佛士酒店'],
    'lat': [1.3056, 1.3644, 1.2865, 1.2925, 1.2905, 1.3068, 1.3023, 1.2839, 1.3138, 1.2834, 1.2815, 1.2494, 1.3130, 1.2952, 1.2907, 1.3039, 1.3036, 1.2895, 1.2949],
    'lon': [103.8237, 103.9915, 103.8270, 103.8465, 103.8463, 103.8516, 103.8596, 103.8436, 103.8159, 103.8607, 103.8636, 103.8303, 103.9045, 103.8520, 103.8484, 103.8256, 103.8087, 103.8510, 103.8546],
    'type': ['Hotel', 'Airport', 'Spot', 'Spot', 'Spot', 'Spot', 'Spot', 'Spot', 'Spot', 'Landmark', 'Landmark', 'Island', 'Recommend', 'Recommend', 'Recommend', 'Bar', 'Bar', 'Event', 'Spot']
})
...
if page == "📅 行程總覽":
    ...
    <div class="hero-container">
        ...
        <p class="hero-subtitle">經典地標 ✕ 萊佛士酒店 ✕ 在地美食 ✕ 濱海灣夜色</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with day_tab1:
        ...
        with col2:
            st.info("👋 歡迎！請先辦理入境、領行李，搭乘計程車/地鐵前往 **JEN Tanglin 飯店** 辦理入住，放下行李後我們第一站前往傳奇的 **萊佛士酒店**！")

        render_spot_card(
            "14:30 - 16:00", "萊佛士酒店 (Raffles Hotel)",
            "這座建於 1887 年的酒店是新加坡最著名的歷史地標，充滿了英式殖民風格的華麗。即便不入住，也能在此感受到時光的沉澱。您可以漫步在飯店的熱帶花園中庭，或參觀白色的長廊建築。最經典的體驗莫過於前往 **Long Bar**，這裡不僅是世界知名的「新加坡司令」雞尾酒發源地，更特別的是，這裡保留了丟花生殼在地上的獨特傳統，這在整潔聞名的新加坡可是非常罕見的趣味體驗。",
            food=["新加坡司令 (Singapore Sling)", "Tiffin Room 英式下午茶"],
            tips="Long Bar 位於飯店二樓，通常下午時段人潮較多，若要喝杯調酒可能需要排隊。這裡的花生是免費提供的，請大膽把殼丟在地上吧！",
            details="""
            **🚇 交通指南：**
            搭乘地鐵至 **City Hall (NS25/EW13)** 站，步行約 5 分鐘即可抵達。
            
            **📸 拍照建議：**
            飯店外牆、大門前的錫克教門衛（穿著正式制服）以及飯店中庭都是絕佳的拍照點。
            """
        )

        render_spot_card(
            "16:30 - 18:00", "中峇魯 (Tiong Bahru)",
        ...
        render_spot_card(
            "18:00 - 19:15", "福康寧公園 (Fort Canning Park)",
        ...
        render_spot_card(
            "19:30 - 22:00", "克拉碼頭 (Clarke Quay) 晚餐與夜遊",
...
# --- NEW: 必買伴手禮清單 ---
    ...
    render_spot_card(
        ...
        "炸得酥脆的魚皮裹上濃育的鹹蛋黃醬，超級涮嘴（也很罪惡）。IRVINS 是最紅的牌子，包裝上有隻黑鴨子。",
        tips="除了原味，辣味也非常受歡迎！",
...
# --- 其他熱門推薦 (Plan B) ---
    ...
    st.info("""
    * **Toast Box (Tanglin Mall)**：最方便！就在飯店樓下商場，吃 Kaya 吐司套餐時記得點份半熟蛋。
    * **Killiney Kopitiam**：最經典！去 Lucky Plaza 或 Killiney Road 本店體驗老字號咖椰吐司。
